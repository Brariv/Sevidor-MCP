...
export default function ChatWidget() {
  ...
  async function handleSend() {
    ...
    try {
      ...
      // Runs on success AND on error: this is what hides the typing dots.
      setLoading(false);
    }
  }
      ...
      {open && (
        ...
        >
          ...
          >
            ...
            {error && (
              <div role="alert" style={{ color: '#d10a0a', fontSize: 13, padding: '0 2px' }}>
                {error}
              </div>
            )}
          ...
          <div style={{ borderTop: '1px solid #e9eaeb', padding: 12, display: 'flex', gap: 8, flex: 'none' }}>
            ...
            <button
              ...
              style={{
                ...
                border: 'none',
                borderRadius: 6,
                background: sendDisabled ? '#e6a3a3' : '#d10a0a',
